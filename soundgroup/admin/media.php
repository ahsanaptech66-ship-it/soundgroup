...
<body class="admin-body">
    ...
    <div class="admin-main-wrap">
      ...
      <main class="admin-main admin-media-main">
        <section class="admin-welcome admin-media-head">
          <div><span class="eyebrow">PHASE 3</span>
            <h1>Shape the music catalog.</h1>
            <p>Upload, edit, publish and curate audio without touching the public site structure.</p>
          </div>
        ...
        <section class="admin-media-toolbar glass-card">
          ...
          <select id="media-sort" class="admin-select">
          ...
          </select><select id="media-status" class="admin-select">
            <option value="all">All status</option>
            <option value="published">Published</option>
            <option value="draft">Draft</option>
          </select><select id="media-flag" class="admin-select">
        ...
        <section class="admin-panel glass-card">
          <div class="admin-panel-head">
            <div><span class="eyebrow">MUSIC LIBRARY</span>
              <h2>Published + draft audio</h2>
            </div><span class="admin-panel-meta" id="media-summary">Loading…</span>
          </div>
          <div class="admin-table-wrap">
            <table class="admin-table admin-media-table">
              <thead>
                <tr>
                  <th><input type="checkbox" id="select-all" aria-label="Select all visible music"></th>
                  <th>Music</th>
                  <th>Artist</th>
                  <th>Genre</th>
                  <th>Status</th>
  ...
  <div class="admin-modal" id="edit-modal" aria-hidden="true">
    ...
    <div class="admin-modal-card glass-card" role="dialog" aria-modal="true" aria-labelledby="edit-modal-title">
      <div class="admin-panel-head">
        <div><span class="eyebrow">EDIT MUSIC</span>
          <h2 id="edit-modal-title">Update track</h2>
      ...
      <form id="edit-form" class="admin-edit-grid">
        ...
        <label class="admin-field"><span>Published</span><select id="edit-published">
            <option value="1">Published</option>
            <option value="0">Draft</option>
          </select></label>
        <label class="admin-field"><span>Featured</span><select id="edit-featured">
            <option value="0">No</option>
            <option value="1">Yes</option>
          </select></label>
        <label class="admin-field"><span>Trending</span><select id="edit-trending">
            <option value="0">No</option>
            <option value="1">Yes</option>
          </select></label><label class="admin-field"><span>Artwork</span><input id="edit-artwork" type="file" accept="image/jpeg,image/png,image/webp,image/gif"><small class="admin-field-note">Optional replacement. Leave empty to keep current.</small></label>
        ...
        <div class="admin-artwork-remove admin-field-wide"><label><input id="edit-remove-artwork" type="checkbox"> Remove current artwork</label></div>
    ...
    <div class="admin-modal-card glass-card admin-bulk-edit-modal-card" role="dialog" aria-modal="true" aria-labelledby="bulk-edit-modal-title">
      <div class="admin-panel-head">
        <div><span class="eyebrow">BULK EDIT</span>
          <h2 id="bulk-edit-modal-title">Edit selected music</h2>
          <p class="admin-modal-subtext"><span id="bulk-edit-selected-count">0</span> items selected. Only status flags will be changed.</p>
        </div><button class="admin-icon-btn" data-close-bulk-edit aria-label="Close">×</button>
      </div>
      <form id="bulk-edit-form" class="admin-edit-grid">
        <label class="admin-field"><span>Published</span><select id="bulk-edit-published">
            <option value="">No change</option>
            <option value="1">Published</option>
            <option value="0">Draft</option>
          </select></label>
        <label class="admin-field"><span>Featured</span><select id="bulk-edit-featured">
            <option value="">No change</option>
            <option value="1">Yes</option>
            <option value="0">No</option>
          </select></label>
        <label class="admin-field"><span>Trending</span><select id="bulk-edit-trending">
            <option value="">No change</option>
            <option value="1">Yes</option>
            <option value="0">No</option>
          </select></label>
